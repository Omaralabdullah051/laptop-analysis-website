    ...
    return (
        <div className='mt-5 mb-10'>
            ...
            <h5 className='p-6 text-justify'>
                ...
                “These virtual worlds, built on our ThinkSystem SR670 V2, will come to life in stunning detail.  The ticket to access these virtual worlds in real time and in high- fidelity detail is delivered by our ThinkStation workstations,” said Tease.  “That level of computing will deliver collaboration opportunities that will unleash unprecedented global creativity.”
            </h5>
        </div>
    );
};
